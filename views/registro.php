      ...
      <div class="card-body">
        ...
        <form id="formulario_registro" method="post">
          <div class="input-group mb-3">
            <input type="text" class="form-control colordelinput" name="nombre_usuario" id="nombre_usuario"
        ...
        <p class="text-left quitarespacios">Al crear una cuenta, confirmo que tengo al menos</p>
        <p class="text-left quitarespacios2"> 16 años y <span class="colorcito">acepto los Términos y Condiciones</span>
        </p>
        <p class="text-left quitarespacios3"> y el <span class="colorcito">Aviso de Privacidad</span> de gameflip.</p>
      </div>
      <!-- /.form-box -->
    </div><!-- /.card -->
  </div>
